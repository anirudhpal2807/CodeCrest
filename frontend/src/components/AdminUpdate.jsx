                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium text-[var(--cc-primary-light)] bg-[rgba(99,102,241,0.1)] hover:bg-[rgba(99,102,241,0.2)] border border-[rgba(99,102,241,0.2)] transition-colors cursor-pointer"
                      >
                        <Pencil size={14} />
                        Edit
                      </button>
