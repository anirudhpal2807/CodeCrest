...
const ProblemPage = () => {
 ...
 useEffect(() => {
  ...
  // Code is now managed per-language; no need to recompute from startCode on tab switch
  useEffect(() => {
                  ...
                  <div>
                    {runResult.success ? (
                      ...
                      <div>
                        ...
                        {runResult.message && (
                          <p className="text-sm text-gray-600 mb-4">{runResult.message}</p>
                        )}
                      ...
                      <div>
                        ...
                        <div className="mt-4 space-y-2">
                          {submitResult.message && (
                            <p className="text-sm text-gray-600 mb-2">{submitResult.message}</p>
                          )}
