  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'linear-gradient(135deg, #0b0f1a 0%, #111827 50%, #0f172a 100%)' }}>
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full opacity-[0.03]" style={{ background: 'radial-gradient(circle, #6366f1, transparent)' }} />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full opacity-[0.04]" style={{ background: 'radial-gradient(circle, #06b6d4, transparent)' }} />
      </div>
      ...
      <div className="relative w-full max-w-md animate-fade-in">
        <div className="cc-card p-8 md:p-10" style={{ background: 'rgba(21, 28, 44, 0.8)', backdropFilter: 'blur(20px) saturate(180%)' }}>
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[var(--cc-text-primary)] mb-1">Welcome back</h1>
            <p className="text-sm text-[var(--cc-text-muted)]">Sign in to your CodeCrest account</p>
          </div>
          ...
          <div className="mt-6 pt-6" style={{ borderTop: '1px solid var(--cc-border)' }}>
            <p className="text-center text-sm text-[var(--cc-text-muted)]">
              ...
              <NavLink to="/signup" className="text-[var(--cc-primary-light)] hover:text-[var(--cc-primary)] font-medium transition-colors">
                Create account
              </NavLink>
            </p>
          </div>
